...
DEFAULT_HOMEPAGE = "chain/Sambacoin";
DEFAULT_TEMPLATE = """
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div id="footer" style="padding-top: 30px">
        <div class="container">
            ...
            <p style="font-size: smaller">
                ...
                Please donate to help us support site: <br /><!-- <srong>BTC:</strong> No one yet! --><strong>SMB:</strong> dXHDYczgN3VuM9kdrnAFEC6iscoCtvqzRF
                <br /><br />
...
class Abe:
    ...
    def search_form(abe, page):
        ...
        return [
            ...
            ' <small>[<a href="#" data-toggle="tooltip" data-placement="bottom" title="Search by address, block number or hash, transaction or public key hash, ',
